        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () async {
                // Ensure the logout operation is awaited before navigating.
                await authProvider.signOut(); 
                // Push the login screen and remove all other routes from the stack.
                // This prevents the user from going "back" to the profile page.
